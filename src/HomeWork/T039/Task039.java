...
public class Task039 {
    public static void Chip(int k, int n, int m, int[][] p) {
        int a;
        int counter = 0;
        int counter2 = 0;
        int counter3;
...
//переписать для 0 в числе
        for (counter = 0; counter < prop; counter++) {
            a = k % 10;//450
            p1[counter] = a;//p1[0]=4
            k = k / 10;
        }
            ...
            for (int j = 0; j < n; j++) {
                ...
                if ((counter2 == p1r.length)) {
                    for (int z = 0; z < p1r.length; z++) {
                        p2[z + counter3][0] = i;
                        p2[z + counter3][1] = j - p1r.length + z + 1;
                    }
                    counter3 += counter2;
                    counter2 = 0;
                }
            ...
            for (int j = 0; j < n; j++) {
                ...
                if ((counter2 == p1s.length)) {
                    for (int z = 0; z < p1s.length; z++) {
                        p3[z + counter3][0] = i;
                        p3[z + counter3][1] = j - p1s.length + z + 1;
                    }
                    counter3 += counter2;
                    counter2 = 0;
                }
        ...
        for (int j = 0; j < n; j++) {
            for (int i = 0; i < m; i++) {
                if ((p[i][j] == p1r[counter2]) && (counter2 < p1r.length)) {
                    counter2++;
                } else if ((p[i][j] != p1r[counter2]) && (counter2 >= 1)) {
                    counter2 = 0;
                    i--;
                } else counter2 = 0;
                ...
                if ((counter2 == p1r.length)) {
                    for (int z = 0; z < p1r.length; z++) {
                        p4[z + counter3][0] = i - p1r.length + z + 1;
                        p4[z + counter3][1] = j;
                    }
                    counter3 += counter2;
                    counter2 = 0;
        ...
        for (int j = 0; j < n; j++) {
            for (int i = 0; i < m; i++) {
                if ((p[i][j] == p1s[counter2]) && (counter2 < p1s.length)) {
                    counter2++;
                } else if ((p[i][j] != p1s[counter2]) && (counter2 >= 1)) {
                    counter2 = 0;
                    i--;
                } else counter2 = 0;
                ...
                if ((counter2 == p1s.length)) {
                    for (int z = 0; z < p1s.length; z++) {
                        p5[z + counter3][0] = i - p1s.length + z + 1;
                        p5[z + counter3][1] = j;
                    }
                    counter3 += counter2;
                    counter2 = 0;
            ...
            for (int j = 0, z = 0; j < m1; j++, z++) {
                ...
                if ((counter2 == p1r.length)) {
                    for (int z1 = 0; z1 < p1r.length; z1++) {
                        p6[z1 + counter3][0] = j - p1r.length + z1 + 1;
                        p6[z1 + counter3][1] = j + i - p1r.length + z1 + 1;
                    }
                    counter3 += counter2;
                    counter2 = 0;
                }
